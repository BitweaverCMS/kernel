...
array( 'QUERY' =>
	array( 'SQL92' => array(
		...
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='wiki_autolinks' WHERE `name`='autolinks'",
		...
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='wiki_show_page_title' WHERE `name`='page_title'",
		...
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='wiki_history_versions' WHERE `name`='keep_versions'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='wiki_max_versions' WHERE `name`='max_versions'",

		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_use_proxy' WHERE `name`='use_proxy'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_proxy_host' WHERE `name`='proxy_host'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_proxy_port' WHERE `name`='proxy_port'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_user_assigned_modules' WHERE `name`='user_assigned_modules'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_http_domain' WHERE `name`='http_domain'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_https_domain' WHERE `name`='https_domain'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_https_login' WHERE `name`='https_login'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_https_login_required' WHERE `name`='https_login_required'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_direct_pagination' WHERE `name`='direct_pagination'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_edit_help' WHERE `name`='wiki_help'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_online_help' WHERE `name`='help'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_form_help_notes' WHERE `name`='help_notes'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_long_date_format' WHERE `name`='long_date_format'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_long_time_format' WHERE `name`='long_time_format'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_short_date_format' WHERE `name`='short_date_format'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_short_time_format' WHERE `name`='short_time_format'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_display_timezone' WHERE `name`='display_timezone'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_centralized_upload_dir' WHERE `name`='centralized_upload_dir'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_temp_dir' WHERE `name`='temp_dir'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_http_port' WHERE `name`='http_port'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_http_prefix' WHERE `name`='http_prefix'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_https_port' WHERE `name`='https_port'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_https_prefix' WHERE `name`='https_prefix'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_count_admin_pageviews' WHERE `name`='count_admin_pvs'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_max_records' WHERE `name`='max_records'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_language' WHERE `name`='language'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_sender_email' WHERE `name`='sender_email'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='kernel_url_index' WHERE `name`='url_index'",

		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='package_messages' WHERE `name`='package_messu'",
		...
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='themes_slide_style' WHERE `name`='slide_style'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='themes_style' WHERE `name`='style'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='themes_top_bar_dropdown' WHERE `name`='top_bar_dropdown'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='themes_bot_bar' WHERE `name`='bot_bar'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='themes_top_bar' WHERE `name`='top_bar'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='themes_jstabs' WHERE `name`='jstabs'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='themes_left_column' WHERE `name`='left_column'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='themes_right_column' WHERE `name`='right_column'",
		...
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_ldap_userdn' WHERE `name`='auth_ldap_userdn'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_ldap_memberisdn' WHERE `name`='auth_ldap_memberisdn'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_ldap_groupdn' WHERE `name`='auth_ldap_groupdn'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_ldap_basedn' WHERE `name`='auth_ldap_basedn'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_ldap_adminuser' WHERE `name`='auth_ldap_adminuser'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_ldap_adminpass' WHERE `name`='auth_ldap_adminpass'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_ldap_groupattr' WHERE `name`='auth_ldap_groupattr'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_ldap_groupoc' WHERE `name`='auth_ldap_groupoc'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_ldap_host' WHERE `name`='auth_ldap_host'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_ldap_memberattr' WHERE `name`='auth_ldap_memberattr'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_ldap_port' WHERE `name`='auth_ldap_port'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_ldap_scope' WHERE `name`='auth_ldap_scope'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_ldap_userattr' WHERE `name`='auth_ldap_userattr'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_ldap_useroc' WHERE `name`='auth_ldap_useroc'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_auth_method' WHERE `name`='auth_method'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_auth_skip_admin' WHERE `name`='auth_skip_admin'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_auth_create_gBitDbUser' WHERE `name`='auth_create_gBitDbUser'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_auth_create_user_auth' WHERE `name`='auth_create_user_auth'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_webserverauth' WHERE `name`='webserverauth'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_allow_register' WHERE `name`='allow_register'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_forgot_pass' WHERE `name`='forgot_pass'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_show_all_modules_always' WHERE `name`='modallgroups'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_pass_due' WHERE `name`='pass_due'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_remember_me' WHERE `name`='rememberme'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_remember_time' WHERE `name`='remembertime'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_userfiles_quota' WHERE `name`='userfiles_quota'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_uf_use_db' WHERE `name`='uf_use_db'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_min_pass_length' WHERE `name`='min_pass_length'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_users_preferences' WHERE `name`='users_preferences'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_display_name' WHERE `name`='display_name'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_change_language' WHERE `name`='change_language'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_case_sensitive_login' WHERE `name`='case_sensitive_login'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_watches' WHERE `name`='user_watches'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_custom_home' WHERE `name`='custom_home'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_clear_passwords' WHERE `name`='clear_passwords'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_validate_email' WHERE `name`='validate_email'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_validate_user' WHERE `name`='validate_user'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_register_passcode' WHERE `name`='use_register_passcode'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_random_number_reg' WHERE `name`='rnd_num_reg'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_register_passcode' WHERE `name`='register_passcode'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_pass_chr_num' WHERE `name`='pass_chr_num'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='users_eponymous_groups' WHERE `name`='eponymous_groups'",

		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='events_list' WHERE `name`='feature_list_events'",
		...
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='pigeonholes_list_style' WHERE `name`='pigeonholes_list_style'",
		...
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='artist_default_ordering' WHERE `name`='artist_default_ordering'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='artist_list_artist_id' WHERE `name`='artist_list_artist_id'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='artist_list_title' WHERE `name`='artist_list_title'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='artist_list_short_description' WHERE `name`='artist_list_short_description'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='album_default_ordering' WHERE `name`='album_default_ordering'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='album_list_album_id' WHERE `name`='album_list_album_id'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='album_list_title' WHERE `name`='album_list_title'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='album_list_short_description' WHERE `name`='album_list_short_description'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='album_list_artists' WHERE `name`='album_list_artists'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='song_default_ordering' WHERE `name`='song_default_ordering'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='song_list_song_id' WHERE `name`='song_list_song_id'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='song_list_title' WHERE `name`='song_list_title'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='song_list_artist' WHERE `name`='song_list_artist'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='song_list_album' WHERE `name`='song_list_album'",
		...
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='liberty_default_format' WHERE `name`='default_format'",
