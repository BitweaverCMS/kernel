...
array( 'QUERY' =>
	array( 'SQL92' => array(
		...
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='pretty_urls_extended' WHERE `name`='feature_pretty_urls_extended'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='messages_allow_messages' WHERE `name`='allowMsgs'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='users_themes' WHERE `name`='feature_user_theme'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='categories_objects' WHERE `name`='feature_categoryobjects'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='categories_path' WHERE `name`='feature_categorypath'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='liberty_offline_thumbnailer' WHERE `name`='feature_offline_thumbnailer'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='kernel_server_name' WHERE `name`='feature_server_name'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='output_obzip' WHERE `name`='feature_obzip'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='themes_edit_css' WHERE `name`='feature_editcss'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='html_pages' WHERE `name`='feature_html_pages'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='themes_module_controls' WHERE `name`='feature_modulecontrols'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='themes_collapsible_modules' WHERE `name`='feature_collapsible_modules'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='kernel_live_support' WHERE `name`='feature_live_support'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='themes_dropdown_navbar' WHERE `name`='feature_dropdown_navbar'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='users_layouts' WHERE `name`='feature_user_layout'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='users_preferences' WHERE `name`='feature_user_preferences'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='sample_list_samples' WHERE `name`='feature_listSamples'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='stats_search' WHERE `name`='feature_search_stats'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='wiki_last_changes' WHERE `name`='feature_last_changes'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='wiki_like_pages' WHERE `name`='feature_like_pages'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='wiki_list_pages' WHERE `name`='feature_list_pages'",
		"UPDATE `".BIT_DB_PREFIX."kernel_prefs` SET `name`='wiki_user_versions' WHERE `name`='feature_userVersions'",
