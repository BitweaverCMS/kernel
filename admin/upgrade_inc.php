...
array( 'QUERY' =>
	array( 'SQL92' => array(
		...
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='wiki_backlinks' WHERE `name`='feature_backlinks'",
		...
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_online_help' WHERE `name`='feature_help'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_form_help' WHERE `name`='feature_helpnotes'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_help_popup' WHERE `name`='feature_helppopup'",
		...
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_edit_help' WHERE `name`='feature_wikihelp'",
		...
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_slide_style' WHERE `name`='slide_style'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_top_bar_dropdown' WHERE `name`='top_bar_dropdown'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_show_all_modules_always' WHERE `name`='modallgroups'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_disable_jstabs' WHERE `name`='disable_jstabs'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_top_bar' WHERE `name`='top_bar'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_bot_bar' WHERE `name`='bot_bar'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_left_column' WHERE `name`='left_column'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_right_column' WHERE `name`='right_column'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_biticon_display_style' WHERE `name`='biticon_display'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_disable_fat' WHERE `name`='disable_fat'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_hide_my_top_bar_link' WHERE `name`='hide_my_top_bar_link'",
	...
	//	"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `value`='small' WHERE `name`='liberty_auto_display_attachment_thumbs'",
		...
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_use_load_threshold' WHERE `name`='use_load_threshold'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_load_threshold' WHERE `name`='load_threshold'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_output_obzip' WHERE `name`='output_obzip'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_help_popup' WHERE `name`='help_popup'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_store_session_db' WHERE `name`='session_db'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_use_proxy' WHERE `name`='use_proxy'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_proxy_host' WHERE `name`='proxy_host'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_proxy_port' WHERE `name`='proxy_port'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_user_assigned_modules' WHERE `name`='user_assigned_modules'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_http_domain' WHERE `name`='http_domain'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_https_domain' WHERE `name`='https_domain'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_https_login' WHERE `name`='https_login'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_https_login_required' WHERE `name`='https_login_required'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_direct_pagination' WHERE `name`='direct_pagination'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_edit_help' WHERE `name`='wiki_help'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_form_help' WHERE `name`='help_notes'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_long_date_format' WHERE `name`='long_date_format'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_long_time_format' WHERE `name`='long_time_format'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_short_date_format' WHERE `name`='short_date_format'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_short_time_format' WHERE `name`='short_time_format'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_display_timezone' WHERE `name`='display_timezone'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_upload_dir' WHERE `name`='centralized_upload_dir'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_temp_dir' WHERE `name`='temp_dir'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_http_port' WHERE `name`='http_port'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_http_prefix' WHERE `name`='http_prefix'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_https_port' WHERE `name`='https_port'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_https_prefix' WHERE `name`='https_prefix'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_sender_email' WHERE `name`='sender_email'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_url_index' WHERE `name`='url_index'",
		"UPDATE `".BIT_DB_PREFIX."kernel_config` SET `name`='site_online_help' WHERE `name`='help'",
