{* $Header: /cvsroot/bitweaver/_bit_kernel/modules/mod_powered_by.tpl,v 1.12 2007/08/31 01:43:28 laetzer Exp $ *}
{strip}
	...
	<ul style="text-align:center;">
		...
		<li>
			{if $gBitDbSystem eq 'adodb'}
				<a href="http://adodb.sourceforge.net/">{biticon ipackage="liberty" iname="adodb" ipath="bitweaver$size/" iexplain="Powered by Adodb" iforce=icon}</a></li>
			{else}
