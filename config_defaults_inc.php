<?php
/**
 * @version $Header: /cvsroot/bitweaver/_bit_kernel/config_defaults_inc.php,v 1.43 2008/12/07 07:31:49 squareing Exp $
 * @package kernel
...
define( 'BIT_LEVEL',			'beta' ); // dev < alpha < beta < RC# < '' < pl
