		...
		{jstab title="Server Settings"}
			{legend legend="Page Setup"}
				...
				<div class="control-group submit">
					<input type="submit" class="ink-button" name="serverTabSubmit" value="{tr}Change preferences{/tr}" />
				</div>
			{/legend}
		{/jstab}
...
*}
		...
		{jstab title="Site Access"}
			{legend legend="Site Access"}
				...
				<div class="control-group submit">
					<input type="submit" class="ink-button" name="siteTabSubmit" value="{tr}Change preferences{/tr}" />
				</div>
			{/legend}
		{/jstab}
		...
		{jstab title="Proxy"}
			{legend legend="Proxy Settings"}
				...
				<div class="control-group submit">
					<input type="submit" class="ink-button" name="proxyTabSubmit" value="{tr}Change preferences{/tr}" />
				</div>
			{/legend}
		{/jstab}
	{/jstabs}
