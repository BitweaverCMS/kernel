...
{form}
		...
		{jstab title="Miscellaneous"}
			{legend legend="Date and Time Formats"}
				<div class="row">
					...
					{forminput}
						{html_checkboxes name="site_display_reltime" values="y" labels=false id="site_display_reltime"}
	...
	<div class="control-group submit">
		<input type="submit" class="ink-button" name="change_prefs" value="{tr}Change preferences{/tr}" />
	</div>
{/form}
{/strip}
