...
<script type="text/javascript" src="{$smarty.const.UTIL_PKG_URL}javascript/bitweaver_gzip.php?jsfile=bitweaver.js"></script>
{if $loadAjax}
	{if $jsDebug}
		<script type="text/javascript" src="{$smarty.const.UTIL_PKG_URL}javascript/bitweaver_gzip.php?jsfile=libs/prototype_1.4.js"></script>
		<script type="text/javascript" src="{$smarty.const.UTIL_PKG_URL}javascript/bitweaver_gzip.php?jsfile=debugger.js"></script>
	{else}
		<script type="text/javascript" src="{$smarty.const.UTIL_PKG_URL}javascript/bitweaver_gzip.php?jsfile=libs/prototype.js"></script>
	{/if}
	<script type="text/javascript" src="{$smarty.const.UTIL_PKG_URL}javascript/bitweaver_gzip.php?jsfile=ajax.js"></script>
{/if}
{strip}
